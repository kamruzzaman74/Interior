...
import FerosaGallery from "./FerosaGallery "
  ...
  return (
    <div className="pt-24 bg-gray-50 min-h-screen">
      ...
      <section className="text-center py-20 px-4 bg-gradient-to-br from-pink-100 to-purple-100">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-8 animate-slide-in">
          Transforming spaces into artistic elegance with modern interior designs
          and expert construction services.
        </p>
        <a
          href="/#contact"
          className="inline-block px-8 py-3 bg-purple-600 hover:bg-purple-700 text-white text-lg rounded-full shadow-md transition transform hover:scale-105"
        >
      ...
      <section className="grid md:grid-cols-3 gap-6 px-4 py-16 max-w-6xl mx-auto">
        {["an3.jpg",
          "ggjpg.jpg",
          "kk.jpg"].map((src, index) => (
          <div
            key={index}
            className="overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition duration-500 animate-fade-in"
          >
            <img
              src={src}
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 animate-slide-in">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            <div className="bg-gradient-to-br from-purple-50 to-white p-6 rounded-xl shadow-lg w-full md:w-1/3 animate-fade-in">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-white p-6 rounded-xl shadow-lg w-full md:w-1/3 animate-fade-in">
            ...
            <div className="bg-gradient-to-br from-pink-50 to-white p-6 rounded-xl shadow-lg w-full md:w-1/3 animate-fade-in">
