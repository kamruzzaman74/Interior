...
const AICostEstimator = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-yellow-100 via-white to-yellow-50 py-16 px-6 sm:px-10 lg:px-24">
      {/* Background Image */}
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative bg-white/70 backdrop-blur-lg shadow-2xl rounded-3xl max-w-4xl mx-auto p-8"
      >
